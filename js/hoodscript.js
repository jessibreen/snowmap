...
,tblName = "cartodb_snow" // cartoDB table name
...
//,twiturl = "https://twitter.com/jessibreen" //Links to my twit acct, change it if you want or remove twitter link altogether
,myPath = "http://ukmapshop.carto.com/api/v2"; //this is the root path to your cartoDB instance with the v2 api param
/*--------------------------
...
function go(){
  ...
  $("#mapItMenu").append('<li style="top:-9px;padding-right:2px;position:relative"><h3 class="navText">{</h3></li>');
	...
	$('.cityState').click(function() {
		...
		document.getElementById("mapTitle").innerHTML = this.id+"<font size='4'><b>SNOW</b></font>"; 
  ...
  //CHECK IF Neighborhood has a name
    ...
    alert("Your data has been added! Draw more or take a look what has been added so far by clicking 'View Maps'.");
  });
